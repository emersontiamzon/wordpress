...
add_action('macho/options/field/email/render', array('Macho_Email_Field', 'render'), 1, 2);

/**
 * Macho_Email_Field simple text field.
 */
class Macho_Email_Field extends Macho_Field{
