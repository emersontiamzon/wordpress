...
add_action('macho/options/field/switch/render', array('macho_Switch_Field', 'render'), 1, 2);
add_action('macho/options/field/switch/enqueue', array('macho_Switch_Field', 'enqueue'), 1, 2);

/**
 * macho_Switch_Field custom jQuery switch field made using a select element and the jQuery UI slider.
 */
class macho_Switch_Field extends macho_Field{
