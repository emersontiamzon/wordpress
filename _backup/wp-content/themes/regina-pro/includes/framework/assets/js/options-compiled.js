            ...
            $.each(macho.conditionals, function(index, conditional) {
                ...
                $.each(conditional, function(inx, cond) {
                    ...
                    $.each(cond, function(_index, _cond) {
                        ...
                        if ($.macho.filter.apply("macho/validate/" + _cond.type, {
                                value: _cond.value,
                                supplied: val
                            }) === false) {
                            $show = false;
...
(function($) {
    ...
    $.macho.ace = {
        ...
        init: function() {
            if ($.macho.is_clone_field(this.$el)) {
                return false;
            }
            ...
            editor.getSession().on("change", function(e) {
                ...
                $(document).trigger("macho/field/change", $(textarea));
            });
        }
    };
    ...
    $.macho.filter.add("macho/field/ace/value", function(id) {
        return $("#field-" + id).find("textarea").first().val();
    });
    $(document).on("macho/create_fields", function(e, el) {
...
(function($) {
    ...
    $(document).on("macho/create_fields", function(e, el) {
        $(el).find('.field-type-background input[type="text"].color').each(function() {
            $.macho.background.color.set({
                $el: $(this)
            }).init();
        });
    });
    $(document).on("macho/field/change", function() {
...
(function($) {
    ...
    $.macho.filter.add("macho/field/checkbox/value", function(id) {
        var val = [];
...
(function($) {
    ...
    $.macho.filter.add("macho/field/color/value", function(id) {
        return $("#field-" + id).find('input[type="text"]').first().val();
    });
    $(document).on("macho/validate/color", function(e, id, data) {
        var msg = data.msg;
        if (!$.trim($(".options-table #" + id).val()).length) {
            if (!$(".options-table #" + id).closest("tr").hasClass("options-required")) {
                $(".options-table #" + id).closest("tr").addClass("options-required");
...
(function($) {
    ...
    $.macho.filter.add("macho/field/date/value", function(id) {
        return $("#field-" + id).find('input[type="text"]').first().val();
    });
})(jQuery);
...
(function($) {
    ...
    $(document).on("click keyup keydown focus", ".field-type-editor, .field-type-editor *", function() {
        $(document).trigger("macho/field/change", $(this).closest("tr"));
        var eid = $(this).find("textarea.wp-editor-area").attr("id"), editor = tinyMCE.get(eid);
        if (editor) {
            editor.save();
        }
    });
    $.macho.filter.add("macho/field/editor/value", function(id) {
...
(function($) {
    ...
    $.macho.filter.add("macho/field/email/value", function(id) {
...
(function($) {
    ...
    $(document).on("click", ".field-type-export a", function() {
        window.location.href = macho.ajax_url + "?action=macho_export&type=" + macho.context + "&option=" + macho.option_name + "&rel_id=" + macho.rel_id + "&_wpnonce=" + macho.nonce;
        return false;
    });
})(jQuery);
...
(function($) {
            ...
            init: function() {
                ...
                var select = $(this.$el).selectize({
                    ...
                    onChange: function(value) {
                        $(document).trigger("macho/field/font/preview", $(this.$el).closest(".field-type-font"));
                        $(document).trigger("macho/field/change");
                    }
                });
                ...
                $(document).on("change input", "#" + $(this.$el).closest(".field-type-font").closest("tr").attr("id") + " input," + "#" + $(this.$el).closest(".field-type-font").closest("tr").attr("id") + " select", function() {
                    $(document).trigger("macho/field/font/preview", $(this).closest(".field-type-font"));
                });
            }
        },
    ...
    $(document).on("macho/created_fields", function() {
        setTimeout(function() {
            $(".selectize-control").each(function() {
                $.macho.font.loadremote($(this).find(".item").first());
            });
        }, 1e3);
    });
    $(document).on("macho/field/font/preview", function( evt, el ) {
        var family = $(el).find("select.font-family").val();
        var color = $(el).find('input[type="text"].color').val();
        var height = $(el).find('input[type="text"].line-height').val();
        var size = $(el).find('input[type="text"].font-size').val();
        var units = $(el).find('input[type="hidden"].units').val();
        $(el).find(".font-preview").css({
            "font-family": family,
            color: color,
    ...
    $.macho.filter.add("macho/field/font/value", function(id) {
        return $("#field-" + id).find("select").first().val();
    });
    $(document).on("macho/validate/font", function(e, id, data) {
        var msg = data.msg;
        if (!$.trim($(".options-table #" + id).val()).length) {
            if (!$(".options-table #" + id).closest("tr").hasClass("options-required")) {
                $(".options-table #" + id).closest("tr").addClass("options-required");
...
(function($) {
    ...
    $.macho.filter.add("macho/field/gallery/value", function(id) {
...
(function($) {
    ...
    $(document).on("click", ".options-group-add a", function() {
        ...
        var clone = $(id).html().replace(re, "i-" + $.macho.group.guid());
        $("#options-group-table-" + target + " > tbody").append(clone);
        // if ($(this).attr("data-layout") == "horizontal") {
        //     $(document).trigger("macho/create_fields", $("#options-group-table-" + target + " > tbody tr:last-child"));
        //     $(document).trigger("macho/created_fields", [ $("#options-group-table-" + target + " > tbody tr:last-child") ]);
        // } else if ($(this).attr("data-layout") == "vertical") {
        //     $(document).trigger("macho/create_fields", $("#options-group-table-" + target + " > tbody tr:last-child").find("table"));
        //     $(document).trigger("macho/created_fields", [ $("#options-group-table-" + target + " > tbody tr:last-child").find("table") ]);
        // }
        $.macho.group.sortable();
        return false;
    });
    ...
    $(document).on("macho/created_fields", function(e, el) {
        $.macho.group.sortable();
    });
})(jQuery);
...
(function($) {
    ...
    $.macho.import = {
        ...
        init: function() {
            $(document).on("click", ".field-type-import .upload", function() {
                ...
                var macho_import_frame = wp.media({
                    className: "media-frame macho-media-frame",
                    frame: "select",
                    multiple: false,
                ...
                macho_import_frame.on("select", function() {
                    var file = macho_import_frame.state().get("selection").first().toJSON();
                    macho_import_frame.close();
                    $.macho.proccess_required = false;
                    $("#macho-import-file").val(file.id);
                    $(".wrap form").submit();
                    $.macho.proccess_required = true;
                    return false;
                });
                macho_import_frame.open();
                return false;
            });
        }
    };
    ...
    $.macho.filter.add("macho/field/import/value", function(id) {
        return false;
    });
})(jQuery);
...
(function($) {
    ...
    $(document).on('macho/create_fields', function(e, el){
        $(el).find('.field-type-heading').each(function(){
            $.macho.heading.set({ $el : $(this) }).init();
        });
    });
    
    //we must fire it here even though it duplicates it
    $('.wrap').find('.field-type-heading').each(function(){
        $.macho.heading.set({ $el : $(this) }).init();
    });
...
(function($) {
    ...
    $.macho.media = {
        ...
        init: function() {
            $(document).on("click", ".field-type-media .upload", function(evt) {
                evt.preventDefault();
                var el = $(this).closest(".field-type-media");
                var macho_media_frame = wp.media({
                ...
                macho_media_frame.on("select", function() {
                    var media_attachment = macho_media_frame.state().get("selection").first().toJSON();
                    ...
                    if (typeof media_attachment.sizes !== "undefined" && typeof media_attachment.sizes.thumbnail !== "undefined") {
                        ...
                        thumbSrc = macho_media.file_icon;
                    }
                    ...
                    macho_media_frame.detach();
                });
                macho_media_frame.open();
                return false;
            });
    ...
    $.macho.filter.add("macho/field/media/value", function(id) {
        return $("#field-" + id).find('input[type="hidden"]').first().val();
    });
})(jQuery);
...
(function($) {
    ...
    $.macho.filter.add("macho/field/number/value", function(id) {
...
(function($) {
    ...
    $.macho.filter.add("macho/field/password/value", function(id) {
...
(function($) {
    ...
    $.macho.filter.add("macho/field/radio-img/value", function(id) {
...
(function($) {
    ...
    $.macho.filter.add("macho/field/radio/value", function(id) {
        return $("#field-" + id).find('input[type="radio"]:checked').first().val();
    });
})(jQuery);
...
(function($) {
    ...
    $.macho.filter.add("macho/field/search/value", function(id) {
        return $("#field-" + id).find("select").first().val();
    });
    $(document).on("macho/created_fields", function() {
...
(function($) {
    ...
    $.macho.filter.add("macho/field/select/value", function(id) {
        return $("#field-" + id).find("select").first().val();
    });
    $(document).on("macho/created_fields", function() {
...
(function($) {
    ...
    $.macho.filter.add("macho/field/switch/value", function(id) {
        return $("#field-" + id).find("select").first().val();
    });
...
(function($) {
    ...
    $.macho.filter.add("macho/field/text/value", function(id) {
        return $("#field-" + id).find('input[type="text"]').first().val();
    });
})(jQuery);
...
(function($) {
    ...
    $.macho.filter.add("macho/field/textarea/value", function(id) {
        return $("#field-" + id).find("textarea").first().val();
    });
})(jQuery);
...
(function($) {
    ...
    $.macho.filter.add("macho/field/url/value", function(id) {
...
(function($) {
    ...
    // for existing icon picker
	$('.icon-picker').iconPicker();

    // for icon picker added with ajax
    $(document).on("click", ".options-group-add a", function() {
        $('.icon-picker').iconPicker();
    });
})(jQuery);
