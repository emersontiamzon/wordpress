					...
					<ul class="main-menu">
						...
						<?php if ( $show_appointment_in_menu ) : ?>
							<li class="hide-mobile">
								<a href="<?php echo $appointment_url; ?>" title="<?php _e( 'Book Appointment', 'regina' ); ?>"  class="appointment-link"><span class="<?php echo esc_attr( $appointment_icon ); ?>"></span> <?php echo esc_attr( $appointment_text ); ?>
								</a></li>
						<?php endif ?>

						<li class="hover-item hide-mobile"><span class="nc-icon-glyph ui-2_menu-bold"></span></li>
