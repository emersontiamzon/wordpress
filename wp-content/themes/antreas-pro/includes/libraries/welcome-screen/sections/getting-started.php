...
<div class="feature-section getting-started three-col has-3-columns is-fullwidth">
	...
	<div class="col column">
		...
		<p>
			<a target="_blank"
			   href="<?php echo esc_url( 'https://docs.machothemes.com/?utm_source=antreas-pro&utm_medium=about-page&utm_campaign=docs-button' ); ?>"><?php esc_html_e( 'Full documentation', 'antreas' ); ?></a>
		</p>
	</div><!--/.col-->
