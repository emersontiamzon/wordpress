...
if ( ! function_exists( 'antreas_taxonomy_meta_fields' ) ) {
	function antreas_taxonomy_meta_fields( $title, $post, $cpo_metadata ) {
...
if ( ! function_exists( 'antreas_taxonomy_meta_form' ) ) {
	function antreas_taxonomy_meta_form( $title, $post, $cpo_metadata = null ) {
		$output = '';

		//Call the field creator with the needed data.
		$output .= antreas_taxonomy_meta_fields( $title, $post, $cpo_metadata );
		echo $output;
