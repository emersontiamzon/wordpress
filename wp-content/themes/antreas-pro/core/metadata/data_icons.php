...
if ( ! function_exists( 'antreas_metadata_icons' ) ) {
	function antreas_metadata_icons() {
		$icons_packs = array(
			...
			'linearicons' => array(
				'name'  => 'Linearicons',
				'icons' => antreas_metadata_linearicons(),
			),
			'typicons'    => array(
				'name'  => 'Typicons',
				'icons' => antreas_metadata_typicons(),
			),
		);
...
if ( ! function_exists( 'antreas_metadata_linearicons' ) ) {
	function antreas_metadata_linearicons() {
		$data = array(
			'&#xe800' => '&#xe800',
			'&#xe801' => '&#xe801',
			'&#xe802' => '&#xe802',
...
if ( ! function_exists( 'antreas_metadata_typicons' ) ) {
	function antreas_metadata_typicons() {
		$data = array(
			'&#xe000' => '&#xe000',
			'&#xe001' => '&#xe001',
			'&#xe002' => '&#xe002',
...
if ( ! function_exists( 'antreas_metadata_icons_social' ) ) {
	function antreas_metadata_icons_social() {
		$icons = array(
			'0'        => '--',
			'&#xf09a;' => '&#xf09a', //Facebook
			'&#xf099;' => '&#xf099', //Twitter
		...
		return apply_filters( 'antreas_metadata_icons_social', $icons );
	}
}
