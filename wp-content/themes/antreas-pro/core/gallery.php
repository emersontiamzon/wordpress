...
function antreas_metabox_gallery( $post ) {
...
function antreas_gallery_images( $post_id ) {
	$args   = array(
		'post_type'      => 'attachment',
		'post_status'    => 'inherit',
		'post_parent'    => $post_id,
...
function antreas_gallery_display( $imagelist ) {
...
//Refresh the metabox
function antreas_gallery_refresh_metabox() {

	$parent = $_POST['parent'];
	$loop   = antreas_gallery_images( $parent );
	$images = antreas_gallery_display( $loop );
...
//Remove single image
function antreas_gallery_remove() {
